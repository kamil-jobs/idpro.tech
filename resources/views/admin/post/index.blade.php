            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('admin.post.create')}}" class="btn btn-block btn-outline-dark">Добавить</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ya-tr-span data-index="157-0" data-translated="true"
                                                            ...
                                                            data-type="trSpan">{{$post->title}}</ya-tr-span>
                                            </td>
                                            <td><a href="{{route('admin.post.show', $post->id)}}"><i
                                                        class="fa fa-eye"></i></a></td>
                                            <td><a href="{{route('admin.post.edit', $post->id)}}">Изменить</a>
                                            </td>
                                            <td>
