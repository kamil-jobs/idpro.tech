            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('admin.user.create')}}" class="btn btn-block btn-outline-dark">Добавить</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    <ya-tr-span data-index="151-0" data-translated="true" data-source-lang="en"
                                                ...
                                                data-type="trSpan">Список пользователей
                                    </ya-tr-span>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ya-tr-span data-index="157-0" data-translated="true"
                                                            ...
                                                            data-type="trSpan">{{$user->name}}</ya-tr-span>
                                            </td>
                                            <td><a href="{{route('admin.user.show', $user->id)}}"><i
                                                        class="fa fa-eye"></i></a></td>
                                            <td><a href="{{route('admin.user.edit', $user->id)}}">Изменить</a>
                                            </td>
                                            <td>
